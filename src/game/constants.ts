...
export const POINT_PAUSE_MS = 700

export const MAX_DELTA_SECONDS = 1 / 30
export const PHYSICS_SUBSTEP_DISTANCE = 12

export const SETTINGS_STORAGE_KEY = 'pong-settings-v1'

export const PADDLE_SPEED_MIN = 220
export const PADDLE_SPEED_MAX = 520
